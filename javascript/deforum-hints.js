...
deforum_titles = {
    ...
    "Border": "controls handling method of pixels to be generated when the image is smaller than the frame.",
        "reflect101": "reflects pixels from same edge of the image",
    ...
    "Strength schedule": "(0-1) similarity to previous frame/init image | also reduces steps taken to [steps*(1-strength)]",
    ...
    "Cadence flow factor schedule": "Change amount of flow per frame -/+ (1 is normal, -1 is reverse, 0.5 is half)",
    "Cadence flow behavior": "Apply optical flow before or after cadence blending of images",
    "Cadence optical flow easing": "Allows you to change the curve in and out of each frame's optical flow. 1 = max easing in & out | -1 = max easing out & in | 0 = no easing",
    ...
    // Hybrid Video
    "Generate inputframes": "Initiates extraction of video in video_init_path to 'inputframes' folder in your batch. If static batch name, you only need to do this once.",
