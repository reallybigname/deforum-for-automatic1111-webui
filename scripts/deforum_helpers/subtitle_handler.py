...
param_dict = {
    ...
    "color_coherence_alpha_schedule": {"backend": "color_coherence_alpha_schedule_series", "user": "Color Coherence Alpha Sch", "print": "ColorCoherenceAlphaSch"}, 
    "cadence_diffusion_easing_schedule": {"backend": "cadence_diffusion_easing_schedule_series", "user": "Cadence Diffusion Easing Sch", "print": "CadenceDiffusionEasingSchedule"},
    "cadence_flow_easing_schedule": {"backend": "cadence_flow_easing_schedule_series", "user": "Cadence Flow Easing Sch", "print": "CadenceFlowEasingSchedule"},
    ...
    "cadence_flow_warp_factor_schedule": {"backend": "cadence_flow_warp_factor_schedule_series", "user": "Cadence Flow Warp Factor Sch", "print": "CadenceFlowWarpFactorSchedule"},
    "temporal_flow_factor_schedule": {"backend": "temporal_flow_factor_schedule_series", "user": "Temporal Flow Factor Sch", "print": "TemporalFlowFactorSchedule"},
    "temporal_flow_target_frame_schedule": {"backend": "temporal_flow_target_frame_schedule_series", "user": "Temporal Flow Target Frame Sch", "print": "TemporalFlowTargetFrameSchedule"},
    "temporal_flow_motion_stabilizer_factor_schedule": {"backend": "temporal_flow_motion_stabilizer_factor_schedule_series", "user": "Temporal Flow Motion Stabilizer Factor Sch", "print": "TemporalFlowMotionStabilizerFactorSchedule"},
    "temporal_flow_rotation_stabilizer_factor_schedule": {"backend": "temporal_flow_rotation_stabilizer_factor_schedule_series", "user": "Temporal Flow Rotation Stabilizer Factor Sch", "print": "TemporalFlowRotationStabilizerFactorSchedule"},
    "morpho_schedule": {"backend": "morpho_schedule_series", "user": "Morpho Sch", "print": "MorphoSchedule"},
    "morpho_iterations_schedule": {"backend": "morpho_iterations_schedule_series", "user": "Morpho Iteration Sch", "print": "MorphoIterationSchedule"},
    "morpho_flow_factor_schedule": {"backend": "morpho_flow_factor_schedule_series", "user": "Morpho Flow Factor Sch", "print": "MorphoFlowFactorSchedule"},
    ...
    "loop_comp_type_schedule": {"backend": "loop_comp_type_schedule_series", "user": "Loop Comp Type Sch", "print": "LoopCompTypeSchedule"},
    "loop_comp_alpha_schedule": {"backend": "loop_comp_alpha_schedule_series", "user": "Loop Comp Alpha Sch", "print": "LoopCompAlphaSchedule"},
    "loop_comp_conform_schedule": {"backend": "loop_comp_conform_schedule_series", "user": "Loop Comp Flow Factor Sch", "print": "LoopCompFlowFactorSchedule"},
    "hybrid_comp_conform_schedule": {"backend": "hybrid_comp_conform_schedule_series", "user": "Hyb Comp Conform Sch", "print": "HybridCompConformSchedule"},
    ...
    "hybrid_comp_mask_alpha_schedule": {"backend": "hybrid_comp_mask_alpha_schedule_series", "user": "Hyb Comp Mask Blend Alpha Sch", "print": "HybridCompMaskBlendAlphaSchedule"},
